...
```{r analyze and visualize sentiment, warning=FALSE,message=FALSE}
...
tg_sentiment <- db_sentiment %>%
  ...
  labs(title = "TopGolf Tweet Sentiment", x = "Number of Characters", y = "Sentiment")
tg_sentiment
```

## Correlation

```{r analyze correlation, warning=FALSE,message=FALSE}
